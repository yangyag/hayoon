...
public class GlobalExceptionHandler {
	...
	public org.springframework.http.ResponseEntity<ErrorResponse> handleCardNotFound(
		CardNotFoundException exception,
		HttpServletRequest request
	) {
		return buildResponse(HttpStatus.NOT_FOUND, "CARD_NOT_FOUND", exception.getMessage(), request);
	}
